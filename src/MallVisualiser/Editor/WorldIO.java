...
public class WorldIO {
		...
		try {
			...
			if (i == -1) {
				throw new IOException(
						"Invalid file ending after width specification.");
			}
			...
			if (i == -1) {
				throw new IOException(
						"Invalid file ending after height specification.");
			}

			int[][] worldArray = new int[Integer.parseInt(width)][Integer
					.parseInt(height)];
	...
	public boolean save(File file) {
		try {
			...
			String str = world.getNumElementsX() + " "
					+ world.getNumElementsY() + System.lineSeparator();
