...
public class ResizeMapDialog extends JDialog implements PropertyChangeListener {
	...
	public ResizeMapDialog(Frame parentFrame, WorldIO worldIO) {
		...
		setTitle("Huidige gevangenis schalen");

		textFieldWidth = new JTextField(4);
		textFieldHeight = new JTextField(4);

		// Create an array of the text and components to be displayed.
		String msgString1 = "Geef de nieuwe groote: (vierkant)";
		String msgString2 = "Breedte (X): ";
		// String msgString3 = "Height (Y): ";
		String msgString4 = "Waarschuwing: Informatie zal verloren gaan na het schalen van de gevangenis";
		Object[] array = { msgString1, msgString2, textFieldWidth, msgString4 };
