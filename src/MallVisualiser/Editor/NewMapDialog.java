...
public class NewMapDialog extends JDialog implements PropertyChangeListener {
	...
	public NewMapDialog(Frame parentFrame, WorldIO worldIO) {
		super(parentFrame, true);
		this.worldIO = worldIO;

		setTitle("Ontwerp nieuwe gevangenis");

		textFieldWidth = new JTextField(4);
		textFieldHeight = new JTextField(4);

		// Create an array of the text and components to be displayed.
		String msgString1 = "Geef de groote van de gevangenis: (vierkant)";
		String msgString2 = "Width (X): ";
		// String msgString3 = "Height (Y): ";
		Object[] array = { msgString1, msgString2, textFieldWidth };
		...
		this.setBounds(parentFrame.getWidth() / 2 + parentFrame.getX(),
				parentFrame.getHeight() / 2 + parentFrame.getY(), 100, 100);
		pack();
		...
		if (isVisible()
			...
			if (btnString1.equals(value)) { // Enter pressed
				...
				try {
					...
					JOptionPane.showMessageDialog(NewMapDialog.this,
				...
				// Success:
				worldIO.renewWorld(width, height);
				clearAndHide();
